...
export default function SignUpForm ({ formik }:any)  {
    return (
        ...
        <form className="w-full" onSubmit={formik.handleSubmit}>
          <div>
            ...
            />
            <ErrorResponse formik={formik} name={"firstname"} />
          </div>
          <div>
            ...
            />
            <ErrorResponse formik={formik} name={"lastname"} />
          </div>
          <div>
        ...
        <div className="mt-1">Already have an account, <Link className="text-custom_blue" href="/signin">Sign in</Link></div>
      </ColumnLayout>
    );
}